...
<head>
    ...
    <title>Vzuu HRD Panel | Log in</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ url('login') }}" class="h1"><b>Vzuu</b> Finance Panel</a>
            </div>
            <div class="card-body">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('themes/AdminLTE-3.1.0/dist/js/adminlte.min.js') }}"></script>
</body>
